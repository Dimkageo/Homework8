-- Будинки
INSERT INTO `osbb3`.`buildings` (`id_buildings`, `adress`, `house_number`) VALUES ('15', 'Sunny Street', '15');
INSERT INTO `osbb3`.`buildings` (`id_buildings`, `adress`, `house_number`) VALUES ('16', 'Sunny Street', '16');
